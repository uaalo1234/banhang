<?php require_once('views/admin/auth/index.php') ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo url('auth/handleLogin') ?>" method="POST">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?php echo url('auth/register') ?>">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
